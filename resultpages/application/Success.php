		...
		<div class="container">
			<div class="content">
				...
				<div class="content-text">
					...
					<p>Please check your mailbox for updates</p>
				</div>
				<div class="navigation-icons">
					<a href="http://localhost/Resumeister/user/index.php"><i id ="back-arrow" class="fa-regular fa-user"></i></a>
					<a href="http://mail.google.com"><i class="fa-brands fa-google"></i></a>
					<a href="http://localhost/Resumeister/index.php"><i id="dashboard-icon" class="fa-solid fa-house"></i></a>
